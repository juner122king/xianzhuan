...
public final class KSSdkInitUtil {
    ...
    private static final String APP_KEY = "1423600001";
    public static final Long PosId = 14236000001L;
    ...
    public static void initSDK(Context context) {
        ...
        KsAdSDK.init(context, new SdkConfig.Builder()
                .appId(APP_KEY) // 测试aapId，请联系快手平台申请正式AppId，必填
                .appName("众手帮") // 测试appName，请填写您应用的名称，非必填
