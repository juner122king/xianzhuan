...
public class BulletinView extends NestedScrollView {
    ...
    private static long time = 3000;//滚动间隔 毫秒
...
//      开始动画
    ...
    public void onStart() {//开始滚动
        isStop = false;
        if (adapter != null) mHandler.postDelayed(r, 0);
    }
    ...
    //设置开始动画,可不设置
    public void setmTranslateAnimation(TranslateAnimation mTranslateAnimationStart, TranslateAnimation mTranslateAnimationOut) {
